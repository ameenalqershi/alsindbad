...
enum LocationView { full, icon, cardLarge }

class AppLocation extends StatelessWidget {
  const AppLocation({
    Key? key,
    this.type = LocationView.full,
    this.item,
    this.onPressed,
  }) : super(key: key);

  final LocationView type;
