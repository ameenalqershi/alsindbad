...
//   const ListProduct(
//       {Key? key, this.category, this.brand, this.location, this.feature})
//       : super(key: key);
...
//       _filter.category = widget.category!;
//     }
//     if (widget.brand != null) {
//       _filter.category = Application.submitSetting.categories
//           .singleWhere((item) => item.id == widget.brand?.categoryId);
//       _filter.brand = widget.brand!;
//     }
//     if (widget.feature != null) {
//       _filter.features.add(widget.feature!.id);
//     }
//     if (widget.location != null &&
//         widget.location!.locationType == LocationType.state) {
//       _filter.state = widget.location;
//     }
...
//               hasMap: widget.category?.hasMap ?? false,
//             ),
//             Expanded(
//               child: _buildContent(),
//             )
