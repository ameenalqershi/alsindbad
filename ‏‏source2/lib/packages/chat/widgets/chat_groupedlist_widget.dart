...
import 'package:akarak/packages/chat/widgets/type_indicator_widget.dart';
...
class _ChatGroupedListWidgetState extends State<ChatGroupedListWidget>
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      padding: EdgeInsets.only(bottom: showTypingIndicator ? 50 : 20),
                ...
                indexedItemBuilder: (context, message, index) {
                  return InkWell(
                    ...
                    child: ChatBubbleWidget(
                      key: message.key,
                      isMomentsAgo: index != 0 &&
                          message.createdAt.isAfter(snapshot
                              .data![index - 1].createdAt
                              .add(const Duration(minutes: 10))),
                      isMinutesPassed: index != 0 &&
                          message.createdAt.isAfter(snapshot
                              .data![index - 1].createdAt
                              .add(const Duration(minutes: 59))),
                      isTimePassed: index != 0 &&
                          message.createdAt.isAfter(snapshot
                              .data![index - 1].createdAt
